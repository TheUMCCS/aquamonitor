...
<html>
  <head>
    <title>GoMonitor</title>
    <link rel="stylesheet" href="/goma/web/css/splash.css">		
  </head>
  <body class = "splash">
  	<div id = "container">
    	<div id = "logo">
  			...
  			<br>
  			Catalog of Monitoring Programs 
  		</div>
	  	<div id = "splash-content">		  
		  	<div class = "blurb">
			  	<span>One of the priority issues of the Gulf of Mexico Alliance (GOMA) is monitoring the state of water resources in and near the Gulf. To ensure that its water quality, and other management, goals are realized, GOMA is providing this on-line catalog of all programs or projects in the region that collect information on water quality, biological, biogeochemical and other variables. The GOMA Catalog of Monitoring Programs is publicly available, free of charge.</span> 
				<hr>
				...
				<div class = "splash-menu">
			  	...
			  	<div class = "footer">
			  		<div class = "footer-elem">
			  			<a href = "http://www.gulfofmexicoalliance.org/"><img src = "/goma/web/images/goma-logo.png"></a>
			  		</div>
			  		<div class = "footer-elem">
			  			<a href = "http://ccs.miami.edu"><img src = "/goma/web/images/ccs-logo.png"></a>
			  		</div>
			  		<div class = "footer-elem">
			  			<a href = "http://www.noaa.gov/"><img src = "/goma/web/images/noaa-logo.png"></a>
			  		</div>
			  	</div>
			  </div>
		  	</div>
